...
eq.Equation(p1 - (w1 ** alfa[0, 0]) * (w2 ** alfa[1, 0]) * va[0] - p1 * A[0, 0] - p2 * A[1, 0] == 0)
eq.Equation(p2 - (w1 ** alfa[0, 1]) * (w2 ** alfa[1, 1]) * va[1] - p1 * A[0, 1] - p2 * A[1, 1] == 0)
eq.solve()
print(p1.value, p2.value, y1.value, y1.value, w1.value, w1.value)
